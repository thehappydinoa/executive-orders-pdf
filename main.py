...
def cli(html_file: str, output: str, download_dir: str, concurrent_downloads: int) -> None:
    """Downloads and merges PDFs from Federal Register."""
    asyncio.run(main(html_file, output, download_dir, concurrent_downloads))

async def main(html_file: str, output: str, download_dir: str, concurrent_downloads: int) -> None:
    ...
    with Progress() as progress:
        ...
        downloader.task_id = progress.add_task("[cyan]Downloading...", total=len(pdf_links))
